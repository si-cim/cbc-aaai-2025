...
# Note: adapted from https://pytorch.org/docs/stable/_modules/torch/nn/modules/linear.html#Linear
...
def get_network(num_classes: int, args: argparse.Namespace):
    ...
    # Note: When softmax_pool is True, the effective PIPNet becomes equivalent to a RBFNet
    # or DeepCBCNet with positive reasoning only.
