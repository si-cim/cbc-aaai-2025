...
def get_data(args: Union[argparse.Namespace, OmegaConf]):
    """
    ...
    if args.dataset == "CUB-200-2011":
        if args.notebook:
            return get_birds(
                True,
                Path("../") / CUB_200_2011_TRAIN_CROPPED,
                Path("../") / CUB_200_2011_TRAIN,
                Path("../") / CUB_200_2011_TEST_CROPPED,
                args.image_size,
                args.seed,
                args.validation_size,
                Path("../") / CUB_200_2011_TRAIN,
                Path("../") / CUB_200_2011_TEST,
            )
        else:
            return get_birds(
                True,
...
def get_dataloaders(args: Union[argparse.Namespace, OmegaConf, DictConfig], device):
    """
    Get data loaders
    """
    # Obtain the dataset
...
def create_datasets(
    ...
    train_dir_pretrain: Union[str, Path] = None,
    test_dir_projection: Union[str, Path] = None,
    transform1p=None,
):
